...
@Configuration //也可是再sentinel控制台配置 jar包得换
public class GatewayConfig {
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api1 = new ApiDefinition("product_route").setPredicateItems(new HashSet<ApiPredicateItem>() {
            {
        ...
        ApiDefinition api2 = new ApiDefinition("product_route").setPredicateItems(new HashSet<ApiPredicateItem>() {
            {
